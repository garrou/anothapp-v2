...
const getSeasonWatchedTime = (id: number, num: number): Promise<Response> =>
    httpClient.get(`${PREFIX}/${id}/seasons/${num}/time`);

const getRecommendations = (): Promise<Response> => httpClient.get(`${PREFIX}/recommendations`);
